...
TOTAL JOBS IN SKILLTRACK DATABASE:
${jobs.length}
...
Improving skills: ${
            job.improvingSkills.length
              ? job.improvingSkills.join(", ")
              : "None"
          }
Missing skills: ${
...
IMPORTANT:
Use these calculated SkillTrack match percentages and job requirements when answering career and job questions.
                  ...
                  >
                    ...
                    {message.role === "assistant" && index > 0 && (
                      <div className="mt-5 grid gap-2 border-t border-white/10 pt-4 sm:grid-cols-2">
                        <Link
                          href="/jobs"
                          className="rounded-xl border border-blue-600/20 bg-blue-600/10 px-4 py-3 text-center text-xs font-bold text-blue-300 transition hover:bg-blue-600/20"
                        >
                          View Matching Jobs
                        </Link>
                        ...
                        <Link
                          href="/skill-gap"
                          className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-center text-xs font-bold text-slate-300 transition hover:border-blue-600/30 hover:bg-blue-600/10 hover:text-blue-300"
                        >
                          Analyze Skill Gap
                        </Link>
                        ...
                        <Link
                          href="/interview-coach"
                          className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-center text-xs font-bold text-slate-300 transition hover:border-blue-600/30 hover:bg-blue-600/10 hover:text-blue-300 sm:col-span-2"
                        >
                          Practice Interview
                        </Link>
                      </div>
