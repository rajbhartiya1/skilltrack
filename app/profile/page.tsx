  ...
  >
    Profile
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <section className="mt-6 rounded-3xl border border-white/10 bg-[#163456] p-7">
          <div>
          ...
          <div className="mt-7 grid gap-6 lg:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-[#0B1F3A] px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-700 focus:border-blue-600/40"
              />
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-white/10 bg-[#0B1F3A] px-4 py-3 text-sm leading-6 text-white outline-none transition placeholder:text-slate-700 focus:border-blue-600/40"
              />
            </div>
          </div>
        </section>
        ...
        <section className="mt-6 rounded-3xl border border-blue-600/20 bg-gradient-to-br from-cyan-400/10 via-[#0d1b2e] to-purple-500/10 p-7">
          <div>
          ...
          <div className="mt-7 grid gap-5 lg:grid-cols-[1fr_280px_auto] lg:items-end">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-[#0B1F3A] px-4 py-3 text-sm text-white outline-none placeholder:text-slate-700 focus:border-blue-600/40"
              />
            </div>
          ...
          <div className="mt-7 border-t border-white/10 pt-6">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              ...
              <input
                ...
                className="rounded-xl border border-white/10 bg-[#0B1F3A] px-4 py-2.5 text-xs text-white outline-none placeholder:text-slate-700 focus:border-blue-600/40"
              />
            </div>
              ...
              {filteredSuggestions.map(
                (skill) => (
                  <button
                    ...
                    className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-slate-400 transition hover:border-blue-600/30 hover:bg-blue-600/10 hover:text-blue-300"
                  >
                    + {skill}
                  </button>
                )
        ...
        <section className="mt-6 rounded-3xl border border-teal-500/20 bg-gradient-to-r from-emerald-400/10 via-[#0d1b2e] to-cyan-400/10 p-7">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            ...
            <button
              onClick={saveProfile}
              disabled={saving}
              className="rounded-xl bg-teal-500 px-7 py-4 text-sm font-black text-slate-950 transition hover:bg-emerald-300 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {saving
                ? "Saving Profile..."
                : "Save Profile"}
