...
export default function Dashboard() {
  ...
  const readiness = useMemo(() => {
    ...
    const total = topJobsForReadiness.reduce(
      (sum, job) =>
    ...
    return Math.round(
      total / topJobsForReadiness.length
    );
  }, [recommendedJobs]);
  ...
  const aiCareerInsight = useMemo(() => {
    ...
    if (best.matchPercentage >= 85) {
      return {
        title: best.title,
        percentage: best.matchPercentage,
        message:
    ...
    Profile
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              disabled={refreshing}
              className="hidden rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-slate-300 transition hover:bg-white/10 disabled:opacity-50 sm:block"
            >
              {refreshing
                ? "Refreshing..."
                : "â†» Refresh"}
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-blue-600/20 bg-gradient-to-br from-cyan-400/10 via-[#0d1b2e] to-purple-500/10 p-8 md:p-10">
          <div className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-blue-600/10 blur-3xl" />
          ...
          <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-400 md:text-base">
                Track your skills, discover matching opportunities,
                understand your skill gaps, and build a clearer path
                toward employment.
              </p>
            ...
            <div className="flex shrink-0 flex-col items-center">
              <div className="flex h-44 w-44 items-center justify-center rounded-full border-[10px] border-blue-600/15 bg-blue-600/5">
                <div className="text-center">
        ...
        <section className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-purple-400/10 bg-[#163456] p-6">
            <p className="text-sm text-slate-500">
              Your Skills
            </p>
        ...
        <section className="mt-6 overflow-hidden rounded-3xl border border-purple-400/20 bg-gradient-to-br from-purple-500/15 via-[#0d1b2e] to-cyan-400/10 p-7">
        ...
        {/* ================================================= */}
        {/* RECOMMENDED JOBS + PRIORITY GAPS */}
        {/* ================================================= */}
            ...
            <div className="mt-6 space-y-4">
              {topJobs.length === 0 ? (
                ...
                topJobs.map((job, index) => (
                  <div
                    key={job.id}
                    className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition hover:border-blue-600/30"
                  >
                    <div className="flex flex-col justify-between gap-5 md:flex-row md:items-center">
                      <div className="flex min-w-0 gap-4">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-600/10 text-sm font-black text-blue-600">
                          #{index + 1}
                        </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-[#163456] p-6">
            ...
            <div className="mt-6 space-y-3">
              {priorityGaps.length === 0 ? (
                <p className="rounded-xl bg-white/[0.03] p-4 text-sm text-slate-500">
                ...
                priorityGaps.map(
                  ({ skill, score }, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-red-400/10 text-xs font-black text-red-300">
                          {index + 1}
                        </div>
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-white/10 bg-[#163456] p-6">
            ...
            <div className="mt-7 space-y-5">
              {skills.length === 0 ? (
                <div className="rounded-xl bg-white/[0.03] p-5 text-sm text-slate-500">
                  No skills added yet.
                </div>
              ) : (
                [...skills]
          ...
          <div className="rounded-3xl border border-white/10 bg-[#163456] p-6">
            ...
            <div className="mt-7 space-y-4">
              ...
              <div className="flex items-center justify-between rounded-xl bg-blue-600/5 p-4">
                <div className="flex items-center gap-3">
                  <span className="text-xl">
                    ðŸ“¤
                  </span>
              ...
              <div className="flex items-center justify-between rounded-xl bg-teal-500/5 p-4">
                <div className="flex items-center gap-3">
                  <span className="text-xl">
                    ðŸŽ‰
                  </span>
        ...
        <section className="mt-6 overflow-hidden rounded-3xl border border-blue-600/20 bg-gradient-to-r from-cyan-400/10 via-purple-500/10 to-cyan-400/5 p-7 md:p-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
                Identify the skills employers need, improve your
                proficiency, discover matching jobs, and track
        ...
        <footer className="mt-10 flex flex-col justify-between gap-4 border-t border-white/10 py-6 text-xs text-slate-600 sm:flex-row">
          ...
          <button
            ...
            className="text-left transition hover:text-red-400 sm:text-right"
          >
            Sign out
          </button>
        </footer>
