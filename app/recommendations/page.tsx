      ...
      <main className="min-h-screen bg-[#0B1F3A] text-white">
        <div className="flex min-h-screen items-center justify-center">
          <div className="text-center">
            <div className="mx-auto mb-5 h-12 w-12 animate-spin rounded-full border-4 border-blue-600/20 border-t-cyan-400" />
    ...
    return (
      <main className="min-h-screen bg-[#0B1F3A] px-6 py-20 text-white">
        <div className="mx-auto max-w-xl rounded-3xl border border-red-400/20 bg-red-400/5 p-8 text-center">
          ...
          <Link
            href="/profile"
            className="mt-6 inline-flex rounded-xl bg-blue-600 px-5 py-3 font-bold text-slate-950"
          >
            Update Profile
          </Link>
        </div>
    ...
    <main className="min-h-screen bg-[#0B1F3A] text-white">
      ...
      <header className="hidden sticky top-0 z-30 border-b border-white/10 bg-[#0B1F3A]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          >
            Skill<span className="text-blue-600">Track</span>
          </Link>
...
<Link
  ...
  >
    Profile
          ...
          <Link
            href="/profile"
            className="rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-bold text-slate-950 transition hover:bg-blue-500"
          >
            Update Skills
          </Link>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
        ...
        <section className="relative overflow-hidden rounded-[32px] border border-blue-600/20 bg-gradient-to-br from-cyan-500/10 via-[#101d35] to-purple-500/10 p-7 shadow-2xl md:p-10">
        ...
        <section className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0c1a2d] p-5">
            ...
            <p className="mt-2 text-3xl font-black text-teal-400">
              {jobs.length}
            </p>
            ...
            {careerRecommendations.slice(0, 6).map(
              (career, index) => (
                <button
                  ...
                  className="group rounded-3xl border border-white/10 bg-[#0c1a2d] p-6 text-left transition hover:-translate-y-1 hover:border-blue-600/30 hover:bg-[#102039]"
                >
                  <div className="flex items-start justify-between gap-5">
                    <div className="flex gap-4">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-blue-600/10 text-lg font-black text-blue-600">
                        #{index + 1}
                      </div>
                ...
                <div key={skill.name}>
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      {skill.userHas && (
                        <span className="rounded-md bg-teal-500/10 px-2 py-1 text-[10px] font-bold text-teal-300">
                          YOU HAVE
                        </span>
                      )}
                    </div>
      ...
      {selectedCareer && (
        ...
        >
          <div
            className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-3xl border border-white/10 bg-[#10294A] p-7 shadow-2xl md:p-9"
          ...
          >
            ...
            <div className="mt-7 rounded-2xl border border-blue-600/10 bg-blue-600/5 p-5">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {selectedCareer.matchedSkills
                    ...
                    .map((skill) => (
                      <span
                        key={skill}
                        className="rounded-lg bg-teal-500/10 px-3 py-2 text-xs text-teal-300"
                      >
                        {skill}
                      </span>
                    ))}
