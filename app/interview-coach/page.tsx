      ...
      <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
        ...
        <section className="relative overflow-hidden rounded-[32px] border border-blue-600/20 bg-gradient-to-br from-cyan-500/10 via-[#101d35] to-purple-500/10 p-7 md:p-10">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_320px] lg:items-center">
            ...
            <div className="rounded-3xl border border-white/10 bg-black/20 p-6">
              ...
              <p className="mt-3 text-6xl font-black text-blue-600">
                {readiness}%
              </p>
        ...
        <section className="mt-7 grid gap-6 lg:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-[#0c1a2d] p-6">
            ...
            <select
              ...
              className="mt-4 w-full rounded-xl border border-white/10 bg-[#0B1F3A] px-4 py-3 text-sm font-semibold text-white outline-none focus:border-blue-600"
            >
          ...
          <div className="rounded-3xl border border-blue-600/10 bg-blue-600/5 p-6">
            ...
            <button
              ...
              className="mt-5 w-full rounded-xl bg-blue-600 px-4 py-3 font-bold text-slate-950 hover:bg-blue-500"
            >
              {started
                ? "Restart Interview"
                : "Start Interview †’"}
            ...
            <div className="rounded-3xl border border-white/10 bg-[#0c1a2d] p-6 md:p-8">
              ...
              <div className="mt-7">
                ...
                <textarea
                  ...
                  className="min-h-[240px] w-full resize-none rounded-2xl border border-white/10 bg-[#0B1F3A] p-5 text-sm leading-7 text-white outline-none placeholder:text-slate-700 focus:border-blue-600/50"
                />
              </div>
        ...
        {evaluation && !sessionComplete && (
          <section className="mt-7">
            <div className="rounded-3xl border border-blue-600/20 bg-gradient-to-br from-cyan-500/10 via-[#0c1a2d] to-purple-500/5 p-6 md:p-8">
              <div className="flex flex-col gap-7 lg:flex-row">
                <div className="flex shrink-0 flex-col items-center justify-center rounded-3xl border border-white/10 bg-black/10 p-7 lg:w-52">
                  ...
                  <p className="mt-2 text-6xl font-black text-blue-600">
                    {evaluation.score}
                  </p>
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    {evaluation.missingPoints.length ===
                      0 && (
                      <div className="rounded-xl border border-emerald-400/10 bg-teal-500/5 p-4 text-sm text-teal-300">
                        Excellent coverage!
                      </div>
                    )}
                  </div>
              ...
              <div className="mt-6 flex justify-end">
                <button
                  ...
                  className="rounded-xl bg-blue-600 px-6 py-3 font-bold text-slate-950 hover:bg-blue-500"
                >
                  {questionIndex >=
                  currentQuestions.length - 1
                    ? "Finish Interview †’"
          ...
          <section className="mt-8 rounded-[32px] border border-blue-600/20 bg-gradient-to-br from-cyan-500/10 via-[#0c1a2d] to-purple-500/10 p-7 text-center md:p-12">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <button
                ...
                className="rounded-xl bg-blue-600 px-6 py-3 font-bold text-slate-950"
              >
                Practice Again
              </button>
